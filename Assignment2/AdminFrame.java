...
Usage: 
System: java
Description: Creates a GUI frame to create a new Admin,
            stores Admin in the database
*************************************************/
package Assignment2;
...
public class AdminFrame extends javax.swing.JFrame {
    ...
    public AdminFrame() {
        ...
        JLabel heading = new JLabel("Create new Admin");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int adminID = Integer.parseInt(jTextField4.getText());
        
        Admin admin = new Admin(username, email, pwd, adminID);
        int createResult = AdminDTO.performCreate(admin);
        if(createResult != -1) {
